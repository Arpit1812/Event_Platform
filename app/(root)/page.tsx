...
//                 </div>
//                 <div className="w-3/4">
//                   <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">React 18, Next.js 13 and TypeScript</h3>
...
//                 </div>
//                 <div className="w-3/4">
//                   <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">Fully Customizable</h3>
